...
export default async function ({
  ...
  return (
    <>
      ...
      <div className="mx-auto mt-0 max-w-full sm:px-0 lg:px-0">
        <div className="relative isolate overflow-hidden bg-[#000000] mt-0 px-2 py-12 shadow-2xl sm:rounded-3xl sm:px-24 xl:py-32">
          {/* <h1 className="mx-auto max-w-4xl text-center mt-0  text-6xl font-bold tracking-tight text-white">
            {(await indexLanguageText).h1Text}
          </h1>
          <p className="mx-auto mt-2 px-4 max-w-xl text-center text-xl leading-8 text-[#636262]">
            {(await indexLanguageText).pDescription}
          </p> */}
          {video && (
            <div className="relative z-10 mt-8 bg-[#000000] pb-20 sm:mt-16 sm:pb-24 xl:pb-0">
              <div
        ...
        <div className="relative isolate overflow-hidden bg-[#000000] shadow-2xl shadow-white sm:rounded-xl sm:px-12 xl:py-8">
          <h2 className="mx-auto mt-2 max-w-xl text-center text-3xl leading-8 text-white py-10">
              ...
              <a key={file.number} href={`/${locale}/video/${file.number}`} target="_self">
                <div key={file.prompt}>
                  ...
                  <div className={"flex justify-center items-center"}>
                    <p className="pointer-events-none mt-2 block text-sm font-medium text-gray-400 w-[90%] max-h-20 overflow-hidden overflow-ellipsis">prompt: {file.prompt}</p>
                  </div>
                </div>
              </a>
            ))}
