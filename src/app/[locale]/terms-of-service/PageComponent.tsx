...
const PageComponent = ({
  ...
  return (
    <>
      ...
      />
      <main className="w-[95%] md:w-[65%] lg:w-[55%] 2xl:w-[45%] mx-auto">
        <div className="p-6 prose mx-auto my-auto text-gray-300">
          ...
          <p>
            ...
            className={"text-white"}>https://soramagic.co/privacy-policy</a>
          </p>
          ...
          <p>
            {data('h4_8_p')}<a href="mailto:hi@soramagic.co" className={"text-white"}>hi@soramagic.co</a>.
          </p>
        </div>
      </main>
      <Footer
